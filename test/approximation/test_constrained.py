...
def test_construction(legendre8):
...
def test_change_of_basis(legendre8):
...
def test_dirichlet_and_neumann(legendre8):
...
# -- composes with FunctionSpace --


def test_projection(legendre8):
    dirichlet = ConstrainedBasis.dirichlet(legendre8)
