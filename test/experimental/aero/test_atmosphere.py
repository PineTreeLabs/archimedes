import pytest
import numpy as np
from archimedes.experimental.aero.atmosphere import StandardAtmosphere1976  # Update with your actual module name
...
class TestStandardAtmosphere1976:
    ...
    def test_altitude_range(self, atm):
        ...
        # This test depends on your implementation's handling of out-of-range values
        # You might want to modify based on your expected behavior
    ...
    def test_array_inputs(self, atm):
        ...
        # Test __call__ with arrays if your implementation supports this
        try:
            speeds = np.array([100, 200, 300])
            machs, qbars = atm.__call__(speeds, altitudes)
            # Add appropriate assertions here
            assert len(machs) == 3
            assert len(qbars) == 3
        except:
            # If arrays aren't supported, this test can be skipped
            pass
