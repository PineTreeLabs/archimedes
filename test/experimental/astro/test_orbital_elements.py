...
class TestKeplerElements:
    ...
    def test_elliptical_orbit(self):
        ...
        oe = KeplerElements(10.0e6, 0.5, np.deg2rad(30.0), np.deg2rad(90.0), np.deg2rad(60.0), np.deg2rad(180.0))
        ...
        oe = KeplerElements(10000.0e3, 0.5, np.deg2rad(30.0), np.deg2rad(90.0), np.deg2rad(210.0), np.deg2rad(180.0))
        ...
        # Check conditional offset when ω > 180 degrees
        oe = KeplerElements(10000.0e3, 0.5, np.deg2rad(30.0), np.deg2rad(210.0), np.deg2rad(60.0), np.deg2rad(180.0))
        ...
        oe = KeplerElements(10000.0e3, 0.5, np.deg2rad(30.0), np.deg2rad(210.0), np.deg2rad(60.0), np.deg2rad(200.0))
    ...
    def test_parabolic_orbit(self):
        ...
        oe = KeplerElements(7e6, 1.0, np.deg2rad(45.0), np.deg2rad(60.0), np.deg2rad(120.0), np.deg2rad(90.0))
    ...
    def test_hyperbolic_orbit(self):
        ...
        oe = KeplerElements(-15e6, 1.5, np.deg2rad(60.0), np.deg2rad(30.0), np.deg2rad(300.0), np.deg2rad(120.0))
