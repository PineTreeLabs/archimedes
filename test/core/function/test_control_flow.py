...
from archimedes._core import sym as _sym, SymbolicArray
...
class TestVmap:
    def test_product(self):
        ...
        mv = arc.vmap(vv, (0, None), 0)  #  ([b,a], [a]) -> [b]      (b is the mapped axis)
        ...
        mm = arc.vmap(vv, (None, 1), 1)  #  ([b,a], [a,c]) -> [b,c]  (c is the mapped axis)
    ...
    def test_vmap_unravel(self):
        ...
        p = PointMass(np.array([1., 2.]), np.array([3., 4.]))
