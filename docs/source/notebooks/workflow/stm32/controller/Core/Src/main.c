...
int main(void)
{
    ...
    while (1)
    {
        ...
        controller_u.pos_ref = (log_data.sample_idx < SAMPLE_COUNT / 2) ? 1.0 : 0.0;
...
void sample_callback(void)
{
    ...
    // TODO: HAL_GPIO_WritePin(Motor_INA_GPIO_Port, Motor_INA_Pin, (uint16_t)controller_y.INA);
