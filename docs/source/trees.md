...
For more on working with structured data types, also see [Hierarchical Design Patterns](modular-design.md) and the section of the [C Code Generation](generated/notebooks/codegen/codegen03.md) tutorial dealing with auto-generating C structs.